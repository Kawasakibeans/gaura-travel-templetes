    						...
    						else
    						{
    							...
    							$auto_id_from_table = $row['auto_id'];
    								...
    								$tablestirng.= "		
    									...
    									$tablestirng.="<td><input type='checkbox' id='chk".$auto_id."' name='".$auto_id."_checkoption' value='".$auto_id."@#".$price."@#".$match_hidden."' ".$checked." \/></td>
    									</tr>";
